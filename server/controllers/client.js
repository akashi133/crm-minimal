...
export const getTransactions = async (req, res) => {
  try {
    ...
    const generatSort = () => {
      ...
      const sortFormatted = {
        [sortParsed.field]: (sortParsed.sort = 'asc' ? 1 : -1), // бля если ошибка то убрать скобки
      };

      return sortFormatted; //да я знаю что можно было ретерн не писать а сделать в кавычки))
    };
